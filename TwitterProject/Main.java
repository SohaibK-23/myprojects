...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("PRINTING OUT TWEETS CONTAINING THESE USERNAMES!!!");
        ...
        System.out.println("PRINTING OUT TWEETS CONTAINED IN THIS TIMESPAN!!!");
        ...
        System.out.println("PRINTING OUT TWEETS THAT HAS THESE WORDS!!!");
        System.out.println(filteredWords);

        SocialNetwork create = new SocialNetwork();
        List<Set<String>> mostCliques = create.findCliques(tweetsList);
